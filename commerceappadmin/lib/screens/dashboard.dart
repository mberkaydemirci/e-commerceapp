...
import 'package:commerceappadmin/widgets/small_card.dart';
...
class _DashboardState extends State<Dashboard> {
  List<commoncharts.Series<Task, String>>? _seriesPieData;

  _getData() {
    var piedata = [
      new Task('Girls', 35.8, const Color(0xff3366cc)),
      new Task('Women', 8.3, const Color(0xff990099)),
      new Task('Pants', 10.8, const Color(0xff109618)),
      new Task('Formal', 15.6, const Color(0xfffdbe19)),
      new Task('Shoes', 19.2, const Color(0xffff9900)),
      new Task('Other', 10.3, const Color(0xffdc3912)),
    ];
